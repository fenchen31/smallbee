...
class CoordiantorAdapter: SingleAdapter<ItemCoordinatorlayoutScrollBinding, CoordinatorResponse>(R.layout.item_coordinatorlayout_scroll) {
    override fun bindingItem(
        ...
        //binding.tvText.text = data[position].text
    }
}