...
public class MessageCenterActivity2 extends AbstractActivity<ActivityMessageCenterBinding> {

    private static final String TAG = MessageCenterActivity2.class.getSimpleName();
